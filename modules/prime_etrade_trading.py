...
class PrimeETradeTrading:
        ...
        try:
            ...
            try:
                ...
                if etrade_oauth_modules.exists() and str(etrade_oauth_modules) not in sys.path:
                    ...
                    log.warning("⚠️ central_oauth_manager not available - token renewal skipped (tokens from Secret Manager only)")
                    return False
    ...
    def reload_tokens(self) -> bool:
        ...
        try:
            ...
            log.warning(f"⚠️ Failed to reload E*TRADE tokens from Secret Manager: {e}")
            return False
