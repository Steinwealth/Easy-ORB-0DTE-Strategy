...
🔮 <b>0DTE Options Ready</b> <i>(Long & Short)</i> — complete list ({n_dte} symbols):"""
                    if dte_call_text:
                        dte_section += f"""
...
"""
    ...
    async def send_red_day_alert(self, reason: str, metrics: Optional[Dict[str, Any]] = None,
                                  mode: str = "DEMO", total_scanned: int = 0,
                                  orb_signals_count: int = 0, dte0_signals_qualified: int = 0) -> bool:
        """
...
📊 <b>Market Conditions:</b>
          ...
          • Avg RS vs SPY: {metrics.get('avg_rs_vs_spy', 0):.2f}
          • Avg VWAP Distance: {metrics.get('avg_vwap_distance', 0):.2f}%"""
...
💰 <b>Action Taken:</b>
          ...
          • 0DTE options: <b>CONTINUING</b> (will prioritize PUTs for declining prices)
...
💡 <b>Strategy Impact:</b>
          ...
          • 0DTE Strategy: Will prioritize PUT options (profitable in declining markets)

📊 <b>Next:</b> 0DTE options execution (PUTs prioritized)
          (Throughout trading day)
